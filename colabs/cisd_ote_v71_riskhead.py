...
# Pre-load fold data for all folds (no labeling — reuse v7.0 cache)
print(f'\n{"="*60}')
...
for fold in FOLDS:
    ...
    train_dsets, val_dsets, test_dsets = _load_fold_data(
        fold_cfg, TICKERS, PREPARED_DIR, CISD_CACHE_DIR,
        CISD_FEATURE_COLS, SEQ_LEN, MICRO_TO_FULL,
    )
